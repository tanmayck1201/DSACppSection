...
{
    cout<<"Enter size of an array 'A': ";
    cin>>size;
    cout<<"Enter no. of elements to enter for 'A' Array: ";
    cin>>n;
    for (int i = 0; i < n; i++)
    {
        cin>>A[i];
    ...
    cout<<"Enter size of an array 'B': ";
    cin>>size;
    cout<<"Enter no. of elements to enter for 'B' Array: ";
    cin>>n;
    for (int i = 0; i < n; i++)
    {
        cin>>A[i];
